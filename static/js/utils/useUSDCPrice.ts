import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@photonswap/sdk'
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => {
      return [
        ...
        [wrapped?.equals(USDC[chainId === undefined ? ChainId.CRONOSMAINNET : chainId]) ? undefined : wrapped, chainId === ChainId.CRONOSMAINNET ? USDC[chainId] : undefined],
        [chainId ? WETH[chainId] : undefined, chainId === ChainId.CRONOSMAINNET ? USDC[chainId] : undefined]
      ]
    },
