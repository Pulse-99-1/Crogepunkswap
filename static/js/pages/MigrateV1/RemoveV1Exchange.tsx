...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from '@photonswap/sdk'
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your ${process.env.REACT_APP_NAME} V1 ${chainId && token.equals(WETH[chainId]) ? 'WETH' : token.symbol
          }/CRO liquidity will be redeemed for underlying assets.`}
      </TYPE.darkGray>
    </AutoColumn>
  )
}
